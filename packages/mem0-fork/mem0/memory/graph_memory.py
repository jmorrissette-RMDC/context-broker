...
class MemoryGraph:
    ...
    def search(self, query, filters, limit=100):
        ...
        # FORK: Map reranked results back to original rows to preserve elementId fields.
        # Build lookup from (source, relationship, destination) tuple to full result dict.
        _tuple_to_row = {}
        ...
        for item in reranked_results:
            ...
            if original:
                search_results.append({
                    ...
                    "destination_id": original.get("destination_id"),
                })
            else:
                # Fallback if tuple match fails (e.g., duplicate entity names)
